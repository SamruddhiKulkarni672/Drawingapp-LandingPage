            ...
            <div className="max-w-7xl mx-auto px-6 relative z-10">
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="text-center lg:text-left animate-[fade-in_1s_ease-out]">
                        ...
                        <p className="text-xl text-gray-400 mb-8 max-w-lg mx-auto lg:mx-0">
                            Unleash your creativity with our powerful digital drawing app. Multiple
                            brushes, paint selector, auto video recording, and so much more – all
                            completely free!
                        </p>

                        <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                            <button
                                className="flex items-center justify-center   !bg-purple-500 text-white text-lg px-8 py-4 rounded-md shadow-md hover:shadow-[0_0_15px_rgba(236,72,153,0.5)] transition-all"
                                onClick={() =>
                                    window.open(
                                        "https://tulikadigitaldrawingapp.vercel.app/",
                                        "_blank"
                                    )
                                }
                            >
                            ...
                            <button className="flex items-center justify-center border border-gray-500 text-white text-lg px-8 py-4 rounded-md hover:bg-gray-800 transition-all">
                                <a
                                    href="https://github.com/SamruddhiKulkarni672/tulikadigitaldrawingapp/releases/download/v1.0.0/digital-art-app.exe"
                                    target="_blank"
              ...
              /> */}
                        ...
                        <motion.img
                            src={heroImage1}
                            alt="Digital Drawing App Preview"
                            className="w-full md:w-[700px] h-auto mt-8 md:mt-0"
                            animate={{
                                x: [0, 6, -8, 10, -5, 8, -6, 0], // subtle left-right movement
                                y: [0, -15, 10, -12, 18, -10, 12, 0], // bigger bobbing up & down
                                rotate: [0, 0.5, -0.8, 0.7, -0.6, 0.8, -0.5, 0],
                            }}
                            transition={{
